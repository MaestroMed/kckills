...
export const DEMO_COMMENTS: (Comment & { profile: Profile })[] = [
  {
    ...
    user_id: "u1",
    parent_id: null,
    body: "KYEAHOO PENTA EN FINALE LEC. JE PLEURE. HISTORIC.",
    upvotes: 312,
    is_edited: false,
  ...
  },
  {
    ...
    user_id: "u2",
    parent_id: null,
    body: "Le Corki package sur Caps pour ouvrir le penta... Kyeahoo est trop fort mdr",
    upvotes: 187,
    is_edited: false,
  ...
  },
  {
    ...
    user_id: "u2",
    parent_id: null,
    body: "Kyeahoo steal le Shurima Shuffle de Caps et le tue avec... C'est de la poésie.",
    upvotes: 156,
    is_edited: false,
  ...
  },
  {
    ...
    user_id: "u4",
    parent_id: null,
    body: "Le TRIPLE de Caliste pour égaliser dans la série... Ce sang froid.",
    upvotes: 289,
    is_edited: false,
