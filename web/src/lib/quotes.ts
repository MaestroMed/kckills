...
export const QUOTES: Quote[] = [
  {
    ...
    source: "Stream post-défaite Spring 2024",
    date: "2024-05",
  ...
  {
    id: "canna-mvp",
    text: "En Corée on m'a dit que l'Europe c'était facile. Ils avaient tort. Cette équipe me rend meilleur.",
    author: "Canna",
    role: "TOP KC",
  ...
  {
    id: "bluewall-257",
    text: "257 personnes en déplacement à Barcelone. Aucune équipe française n'a ça. C'est la Blue Wall.",
    author: "Sardoche",
    role: "Caster LFL",
  ...
  {
    id: "busio-worlds",
    text: "J'ai joué deux Worlds avec FlyQuest. Maintenant je veux y amener KC. Cette fanbase le mérite.",
    author: "Busio",
    role: "SUP KC",
    source: "Interview arrivée KC",
    date: "2026-01",
    playerSlug: "Busio",
  },
  {
    id: "kyeahoo-ambition",
    text: "La LEC c'est un autre monde par rapport à la LCK Challengers. Mais je suis prêt, j'ai faim.",
    author: "kyeahoo",
    role: "MID KC",
    source: "Interview arrivée KC 2026",
    date: "2026-01",
    playerSlug: "kyeahoo",
  },
  {
  ...
  {
    id: "caliste-kda",
    text: "9.09 de KDA c'est bien mais je veux le titre. Les stats ça veut rien dire sans le trophée.",
    author: "Caliste",
    role: "ADC KC",
  ...
  {
    id: "canna-worlds",
    text: "En Corée les fans encouragent. En France les fans VIVENT le match avec toi. C'est la première fois que je ressens ça.",
    author: "Canna",
    role: "TOP KC",
