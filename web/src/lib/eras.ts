...
export const ERAS: Era[] = [
  ...
  },
  {
    ...
    period: "Spring 2023",
    phase: "LFL",
    label: "La Traversee du Desert",
    subtitle: "Premiere fois sans playoffs",
    color: "#5B6A8A",
    result: "\uD83D\uDC94 Hors playoffs",
    icon: "\u23F3",
    ...
    coach: "Striker",
    keyMoment:
      "Pour la premiere fois de son histoire, la Karmine Corp rate les playoffs LFL. Roster remanie (depart de Rekkles/113/Hantera), alchimie inexistante, fond de classement. La KC Army est devastee. C'est le point le plus bas et ce qui declenchera, quelques mois plus tard, l'un des plus gros changements de l'histoire du club.",
    events: ["Premiere elimination sans playoffs LFL de l'histoire de KC"],
    clipsQuery: "karmine corp lfl spring 2023",
    links: [
      {
