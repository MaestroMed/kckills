...
export const ERAS: Era[] = [
  ...
  },
  {
    ...
    events: [
      ...
      "LFL Spring 2022 \u2014 3e place (éliminés par BDS Academy)",
  ...
  },
  {
    ...
    subtitle: "L'entrée dans l'ère sombre",
    color: "#FF9800",
    result: "\uD83D\uDC94 10e (dernier)",
    icon: "\uD83C\uDF31",
  ...
  },
  {
    ...
    phase: "LEC",
    label: "Le Cauchemar",
    subtitle: "L'ère sombre \u00b7 reverse sweep G2 brisé",
    color: "#E84057",
    result: "\uD83D\uDC94 10e (dernier)",
    icon: "\uD83D\uDCA5",
  ...
  },
  {
    ...
    period: "Summer 2024",
    phase: "LEC",
    label: "Le Pari Coréen",
    subtitle: "La fin de l'ère sombre \u00b7 Canna + Vladi",
    color: "#FF9800",
  ...
  },
  {
    ...
    events: [
      ...
      "Playoffs : élimination 2-3 vs MKOI en lower bracket final",
    ],
