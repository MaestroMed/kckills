...
const PAGES: Entry[] = [
  ...
  { id: "page-multikills",group: "page", label: "Multi-kills",   subtitle: "Pentas, quadras, triples", href: "/clips?multi=1", searchText: "multikills multi kills penta pentakill quadra quadrakill triple triplekill double doublekill" },
  { id: "page-fbs",       group: "page", label: "First Bloods",  subtitle: "Le tempo des games", href: "/clips?fb=1", searchText: "first blood firstblood premier sang fb tempo opening" },
  ...
  { id: "page-top",     group: "page", label: "Top kills",     subtitle: "Leaderboard",      href: "/clips?sort=impressions",         searchText: "top leaderboard best meilleurs" },
